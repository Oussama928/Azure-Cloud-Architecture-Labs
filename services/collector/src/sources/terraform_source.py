...
class TerraformRun(BaseModel):
    ...
    plan_json_api_url: Optional[str] = None
    apply_json_api_url: Optional[str] = None
...
class TerraformPlan(BaseModel):
    ...
    run_id: str
    status: str
    log_read_url: Optional[str] = None
    json_output_url: Optional[str] = None
...
class TerraformSource:
    ...
    async def get_runs(self, workspace_id: str, since: Optional[datetime] = None) -> List[TerraformRun]:
    ...
    async def get_plan(self, plan_id: str) -> Optional[TerraformPlan]:
    ...
    async def get_apply(self, apply_id: str) -> Optional[TerraformApply]:
        """Get apply details"""
    ...
    def _build_k8s_change(self, change: Dict[str, Any]):
        ...
        from ..models.change_event import KubernetesChangeDetail, ResourceReference
