...
class Correlator:
    ...
    def __init__(
        ...
        model: Optional[ConfidenceModel] = None,
        ...
        # Gremlin client
        self._gremlin_client: Optional[client.Client] = None
        self._g = None
    ...
    def _vertex_to_candidate(self, vertex: Dict[str, Any]) -> Optional[CandidateRanking]:
